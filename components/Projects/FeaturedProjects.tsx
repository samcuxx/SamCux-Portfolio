        ...
        <div className="relative overflow-hidden" style={{ minHeight: '250px' }}>
          {hasValidImage ? (
            <>
              ...
              <div className={`absolute inset-0 bg-gray-200 dark:bg-[#222F43] animate-pulse rounded-l-2xl md:rounded-l-2xl md:rounded-r-none transition-opacity duration-500 ${
