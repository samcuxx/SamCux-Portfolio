    ...
    <div className="py-12">
      <div className="relative group">
        <div className="absolute inset-0 bg-[#ffe400] rounded-2xl rotate-1 
          group-hover:rotate-2 transition-transform opacity-20"></div>
        
        <div className="relative p-12 bg-white dark:bg-[#131C31] rounded-2xl text-center 
        ...
        >
          <h2 className={`${dynaPuff.className} text-3xl md:text-4xl font-bold mb-4 
